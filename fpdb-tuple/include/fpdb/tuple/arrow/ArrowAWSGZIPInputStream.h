...
class [[maybe_unused]] ArrowAWSGZIPInputStream : public arrow::io::InputStream {
public:
  [[maybe_unused]] explicit ArrowAWSGZIPInputStream(std::basic_iostream<char, std::char_traits<char>> &file);
  ~ArrowAWSGZIPInputStream() override;
